              ...
              <v-card-text>
                <v-form @submit.prevent="updatePatient">
                  ...
                  <v-card-actions>
                    ...
                    ></v-checkbox>
                    <v-spacer></v-spacer>
                    <v-btn color="#1A5276" dark type="submit" @submit="updatePatient()">Save</v-btn>
                  </v-card-actions>
                </v-form>
              </v-card-text>
            </v-card>
...
export default {
  ...
  methods: {
    ...
    updatePatient() {
        this.patient.patientId = this.$store.state.user.id;
        PatientService.updatePatientInformation(this.patient).then( 
          () => {
            this.dialog = true;
          }
        );
